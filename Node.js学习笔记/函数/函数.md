<!--
 * @Author: angula
 * @Date: 2020-09-22 16:41:44
 * @LastEditTime: 2020-09-22 16:55:47
 * @FilePath: \JS\Github-前端知识总结仓库\studySummary\Node.js学习笔记\函数\函数.md
-->
# 函数
...
我们可以把一个函数作为变量传递。但是我们不一定要绕这个"先定义，再传递"的圈子，我们可以直接在另一个函数的括
